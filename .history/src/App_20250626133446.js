...
function AppContent() {
  ...
  // 👇 Dock visible if hash is #mindplay or #calmspace-section
  const showDock = hash === '#mindplay' || hash === '#calmspace-section';
  ...
  return (
    <>
      ...
      {/* ✅ Only show Dock on mindplay or calmspace-section hash */}
      {showDock && (
        <Dock
          items={dockItems}
          panelHeight={68}
      ...
      {/* Your navbar and routes stay unchanged */}
