...
function AppContent() {
  ...
  const mindplayInView = useInView(mindplayRef, { amount: 0.4 });
  const calmspaceInView = useInView(calmspaceRef, { amount: 0.4 });
  ...
  return (
    <>
      ...
      {/* ✅ Dock only shows when MindPlay or CalmSpace are visible */}
      {showDock && (
        <Dock
          items={dockItems}
          panelHeight={68}
