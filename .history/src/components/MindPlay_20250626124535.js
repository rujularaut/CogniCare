...
const MindPlay = () => {
  ...
  <div className="card-with-text">
        ...
        />
        <p className="card-description">See a green circle? Tap fast! You’ve got 3 lives, and every miss costs one. Score points, level up, and see how long you can last!</p>
      </div>
    </div>  
    </section>
  );
