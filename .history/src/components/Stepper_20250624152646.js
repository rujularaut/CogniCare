...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#513c7a", color: "#d7cbf9" },
          active: { scale: 1, backgroundColor: "#5227FF", color: "#d7cbf9" },
          complete: { scale: 1, backgroundColor: "#5227FF", color: "#d7cbf9" },
        }}
